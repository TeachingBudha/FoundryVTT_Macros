...
//3) Make sure to add the "Fury Swipes" Feature to the char as well (just create the feature use the +add button, assign it simple salshing 1d8
    // damage)
...
//***If you modify it with that functionality (case an Ursa Warrior can have other sources of mwadmg, which from my POV is super OverPowered), 
    //let me know so I can take a look at your approach
//
